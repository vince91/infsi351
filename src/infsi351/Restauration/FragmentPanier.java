...
>>>>>>> parent of dfb6ac6... J'ai enlev√© support.v4
...
public class FragmentPanier extends Fragment {
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container,
		...
		for(int i =0; i < 2; i ++){
			...
			((TextView)item_cart.findViewById(R.id.cart_price_item)).setText((i+1)*10 + "Ä");
			...
			((TextView)item_drink.findViewById(R.id.cart_price_item)).setText((i+1)*10 + "Ä");
			((LinearLayout)content_drinks).addView(item_drink);
		}
		
		((TextView)view.findViewById(R.id.total_cart)).setText(60 + "Ä");
